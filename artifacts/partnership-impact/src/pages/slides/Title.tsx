    ...
    <div className="w-screen h-screen overflow-hidden relative bg-bg font-body text-text">
      ...
      <div className="absolute inset-0 px-[5vw] py-[5vh] flex flex-col justify-between">
        ...
        <div className="flex justify-between items-end">
          <p className="text-[2vw] text-muted max-w-[48vw] leading-[1.55] [text-wrap:pretty]">
            The effect of ten partnership rounds on Google search visibility and
            direct traffic, measured April 2025 – June 2026.
          </p>
