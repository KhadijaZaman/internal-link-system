 ...
 *
 * This file is the single source of truth for suspicious-TLD detection used by the
 * toxicity scorer and the disavow export. Edit only this file — never backlink-toxicity.ts —
